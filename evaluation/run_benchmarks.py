...
def run_benchmarks():
    ...
    # Initialize Engine and parse testbed
    ...
    ingest_res = tool_manager.index_repositories({
    ...
    # -------------------------------------------------------------
    # Benchmark 1: RepoQA Search Needle Function (SNF)
    # -------------------------------------------------------------
    ...
    token_cost_naive_rag = 4200  # Typical context window dump of entire files
    ...
    # -------------------------------------------------------------
    # Benchmark 2: CodeScaleBench Cross-Repo Dependency Tracing
    # -------------------------------------------------------------
